...
fun FilterChip(
    ...
    val backgroundColor by animateColorAsState(
        if (selected) WabiSabiTheme.colors.brandSecondary else WabiSabiTheme.colors.uiBackground
    )
    ...
    val textColor by animateColorAsState(
        if (selected) Color.Black else WabiSabiTheme.colors.textSecondary
    )
        ...
        val backgroundPressed =
            if (pressed) {
                Modifier.offsetGradientBackground(
                    WabiSabiTheme.colors.interactiveSecondary,
                    200f,
                    0f
                )
            } else {
